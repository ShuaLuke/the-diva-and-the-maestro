...
export const timeline: Entry[] = [
  ...
  { year: '1903', track: 'both', title: 'In Dahomey, and a royal command', text: 'In Dahomey opens on Broadway with Williams and Walker, then sails to London. The company performs at Buckingham Palace for the ninth birthday of the Prince of Wales\'s son. Abbie sings.', chapter: 'Ch. 11–12, Crossing to Freedom, A Royal Fairy Tale', link: '/archive/in-dahomey-cakewalk-1903' },
